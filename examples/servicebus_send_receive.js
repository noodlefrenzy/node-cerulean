//
// This is just a simple example of how to send/receive to service bus using the azure SDK. It has no relation to the
// other code in this module, and is just meant to provide help to those struggling with the SDK's usage pattern.
//
